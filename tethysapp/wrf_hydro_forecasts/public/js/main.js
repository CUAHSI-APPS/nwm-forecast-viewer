...
$(function () {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            infoDiv.html('<p class="error"><strong>' + errorThrown + '</strong></p>');
        },
        success: function (data) {
            if ("error" in data) {
                infoDiv.html('<p class="error"><strong>' + data['error'] + '</strong></p>');
            }
